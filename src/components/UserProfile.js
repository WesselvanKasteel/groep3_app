...
class UserProfile extends React.Component {
    ...
    getUserData = async () => {
        ...
        // setImage(window.location.hostname + ":8000/" + res.data.user.picture_path);
        this.setState({
            image: window.location.hostname + ":8000/" + res.data.user.picture_path
        });
        // setCity(res.data.user.city);
        // setProvince(res.data.user.province);
        // console.log(window.location.hostname + ":8000/" + res.data.user[0].picture_path);
            ...
            <article className="userprofile">
                <section className="userprofile-content">
                    <section className="userprofile-content__info">
                        ...
                        <div className="userprofile-content__info__textdiv">
                            <p className="userprofile-content__info__textdiv1">{ this.state.firstName + " " + this.state.prefix + " " + this.state.lastName}</p>
                            <p className="userprofile-content__info__textdiv2">{ this.state.age + " jaar"}<br/>
                            { this.state.city + ", " + this.state.province }</p>
                        </div>
                    </section>
